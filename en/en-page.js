...
// ─── SEARCH BAR (LAZY INIT — skips if page.js already init'd) ───
...
function initSearchUI() {
  ...
  // Use pre-existing elements if the HTML already has them (en inner pages)
  const existingPanel = document.getElementById('searchPanel');
  if (existingPanel) {
    searchPanel = existingPanel;
  ...
  // Lazy-create elements for pages without pre-built search HTML (en/index.html)
