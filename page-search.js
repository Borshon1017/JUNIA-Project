// ─── SEARCH — Shared for all inner pages (FR) — skips if page.js already init'd ───
;(function() {
const _btn = document.getElementById('searchBtn');
if (!_btn || _btn._psInit) return; // page.js already set up search
...
searchClear.addEventListener('click', () => { if (searchInput.value === '') { closeSearch(); searchBtn.focus(); } else { searchInput.value = ''; searchInput.focus(); renderResults(''); } });
